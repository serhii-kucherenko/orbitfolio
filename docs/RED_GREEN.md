...
|-------|------|------------------|
| Award-100 lab | [`oracles/award-100.test.mjs`](../oracles/award-100.test.mjs) | Full catalog, team ranges, resume content, motion safety, Hybrid learning ladder, selectable public homepage, hire surface, **100 deepened** (≥40-line) unique cells |
