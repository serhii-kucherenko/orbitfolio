...
|-------|------|------------------|
| Award-100 lab | [`oracles/award-100.test.mjs`](../oracles/award-100.test.mjs) | Full catalog, team ranges, resume content, motion safety, Hybrid learning ladder, champion sync, **100** uniquely built designs, hire surface + printable resume, **≥15 deepened** (≥40-line) cells |
