...
- After 100/100 uniqueness, the next fail-then-pass lever is **depth** — cells that still dump shared resume blocks under a thin hero need full award craft (tick 42 raised deepened gate to ≥15)
