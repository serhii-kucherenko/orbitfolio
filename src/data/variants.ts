...
export const variants: VariantMeta[] = [
  ...
  { id: 16, slug: "synthwave-orbit", name: "Synthwave Orbit", thesis: "Retro-future grid horizon + chrome type", stack: ["perspective", "neon"], scores: { coolness: 8.8, comprehensiveness: 8.4, uniqueness: 8.1, motion: 7.8, hireability: 7.6 } },
  ...
  { id: 38, slug: "brutal-orbit", name: "Brutal Orbit", thesis: "Brutalist concrete type slamming into star void", stack: ["brutal", "type"], scores: { coolness: 8.1, comprehensiveness: 8.3, uniqueness: 9.0, motion: 6.2, hireability: 7.8 } },
