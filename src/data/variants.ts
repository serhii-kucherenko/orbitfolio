...
export const variants: VariantMeta[] = [
  ...
  { id: 6, slug: "glass-nebula", name: "Glass Nebula", thesis: "Frosted panels float over deep-space gradient field", stack: ["backdrop", "framer"], scores: { coolness: 8.4, comprehensiveness: 9.0, uniqueness: 7.0, motion: 7.5, hireability: 8.5 } },
  ...
  { id: 8, slug: "split-horizon", name: "Split Horizon", thesis: "Vertical split: void vs signal; dual narrative", stack: ["css", "framer"], scores: { coolness: 7.8, comprehensiveness: 9.0, uniqueness: 8.0, motion: 6.5, hireability: 8.8 } },
  ...
  { id: 10, slug: "editorial-cosmos", name: "Editorial Cosmos", thesis: "Magazine spreads in space — large pull quotes", stack: ["editorial", "type"], scores: { coolness: 8.0, comprehensiveness: 8.5, uniqueness: 8.5, motion: 6.5, hireability: 8.2 } },
  { id: 11, slug: "void-minimal", name: "Void Minimal", thesis: "Near-empty black; single star cursor; sparse type", stack: ["minimal", "cursor"], scores: { coolness: 7.5, comprehensiveness: 8.0, uniqueness: 9.0, motion: 6.0, hireability: 7.5 } },
  { id: 12, slug: "holo-deck", name: "Holo Deck", thesis: "Holographic scanlines + projected experience slabs", stack: ["css", "scan"], scores: { coolness: 8.4, comprehensiveness: 8.5, uniqueness: 8.5, motion: 7.5, hireability: 7.8 } },
  { id: 13, slug: "galaxy-rail", name: "Galaxy Rail", thesis: "Horizontal scroll through career galaxies", stack: ["horizontal", "lenis"], scores: { coolness: 8.2, comprehensiveness: 8.5, uniqueness: 8.8, motion: 7.5, hireability: 7.5 } },
  ...
  { id: 15, slug: "ascii-orbit", name: "ASCII Orbit", thesis: "ASCII art starfields and mono manifesto", stack: ["ascii", "pre"], scores: { coolness: 7.8, comprehensiveness: 8.5, uniqueness: 9.2, motion: 5.5, hireability: 7.0 } },
  { id: 16, slug: "synthwave-orbit", name: "Synthwave Orbit", thesis: "Retro-future grid horizon + chrome type", stack: ["perspective", "neon"], scores: { coolness: 8.7, comprehensiveness: 8.0, uniqueness: 8.0, motion: 7.5, hireability: 7.2 } },
  { id: 17, slug: "clinic-cosmos", name: "Clinic Cosmos", thesis: "Healthcare-AI calm meets deep space precision", stack: ["calm", "teal"], scores: { coolness: 7.5, comprehensiveness: 9.0, uniqueness: 8.0, motion: 6.5, hireability: 9.0 } },
  { id: 18, slug: "code-rain", name: "Code Rain Nebula", thesis: "Matrix rain dissolves into nebula CV reveals", stack: ["canvas", "rain"], scores: { coolness: 8.5, comprehensiveness: 8.5, uniqueness: 8.0, motion: 8.5, hireability: 7.5 } },
  ...
  { id: 20, slug: "signal-mosaic", name: "Signal Mosaic", thesis: "Asymmetric mosaic of proof signals (not card grid)", stack: ["mosaic", "asym"], scores: { coolness: 7.8, comprehensiveness: 9.0, uniqueness: 8.2, motion: 7.0, hireability: 8.5 } },
  ...
  { id: 26, slug: "credit-roll", name: "Credit Roll", thesis: "Film end-credits scroll of career", stack: ["credits", "slow"], scores: { coolness: 7.5, comprehensiveness: 8.0, uniqueness: 9.0, motion: 8.0, hireability: 6.5 } },
  ...
  { id: 29, slug: "tron-lattice", name: "Tron Lattice", thesis: "Light-cycle grid floor + neon corridors", stack: ["3d-css", "neon"], scores: { coolness: 8.5, comprehensiveness: 8.0, uniqueness: 7.5, motion: 7.5, hireability: 7.0 } },
  ...
  { id: 33, slug: "iso-station", name: "Iso Station", thesis: "Isometric space station rooms as sections", stack: ["iso", "css"], scores: { coolness: 8.2, comprehensiveness: 8.5, uniqueness: 9.0, motion: 7.0, hireability: 7.5 } },
  ...
  { id: 36, slug: "case-immersion", name: "Case Immersion", thesis: "Fullscreen case studies; one proof at a time", stack: ["immersive", "case"], scores: { coolness: 8.0, comprehensiveness: 8.5, uniqueness: 8.0, motion: 7.5, hireability: 8.8 } },
  { id: 37, slug: "swiss-space", name: "Swiss Space", thesis: "Swiss grid discipline + cosmic photography fields", stack: ["swiss", "grid"], scores: { coolness: 7.2, comprehensiveness: 9.2, uniqueness: 8.0, motion: 6.0, hireability: 9.2 } },
  { id: 38, slug: "brutal-orbit", name: "Brutal Orbit", thesis: "Brutalist concrete type slamming into star void", stack: ["brutal", "type"], scores: { coolness: 8.0, comprehensiveness: 8.0, uniqueness: 9.0, motion: 6.0, hireability: 7.0 } },
  ...
  { id: 45, slug: "infinite-canvas", name: "Infinite Canvas", thesis: "Pan/zoom canvas of CV nodes (trackpad/mouse)", stack: ["canvas", "pan"], scores: { coolness: 8.7, comprehensiveness: 8.0, uniqueness: 9.5, motion: 8.0, hireability: 7.0 } },
  ...
  { id: 49, slug: "goals-ring", name: "Goals Ring", thesis: "100 goals as orbital ring around identity", stack: ["goals", "ring"], scores: { coolness: 8.5, comprehensiveness: 8.5, uniqueness: 9.0, motion: 7.5, hireability: 8.0 } },
