...
export const variants: VariantMeta[] = [
  ...
  { id: 25, slug: "docs-workspace", name: "Docs Workspace", thesis: "Notion-like sidebar workspace — pages for home, experience, skills, projects", stack: ["docs", "sidebar", "light"], scores: { coolness: 7.4, comprehensiveness: 9.4, uniqueness: 9.0, motion: 5.0, hireability: 9.1 } },
  ...
  { id: 41, slug: "story-chapters", name: "Story Chapters", thesis: "Warm storybook chapters — numbered narrative arc, not a starfield scroll", stack: ["story", "serif", "light"], scores: { coolness: 8.0, comprehensiveness: 9.3, uniqueness: 9.0, motion: 6.0, hireability: 8.6 } },
  ...
  { id: 46, slug: "cover-series", name: "Cover Series", thesis: "Clickable magazine cover stack — one issue per company + toolkit", stack: ["covers", "stack", "editorial"], scores: { coolness: 8.4, comprehensiveness: 9.2, uniqueness: 9.1, motion: 7.0, hireability: 8.5 } },
  { id: 47, slug: "dual-signal", name: "Dual Signal", thesis: "EN/UA toggle newspaper — bilingual hire surface, light paper", stack: ["i18n", "toggle", "light"], scores: { coolness: 7.9, comprehensiveness: 9.4, uniqueness: 9.3, motion: 5.5, hireability: 9.0 } },
