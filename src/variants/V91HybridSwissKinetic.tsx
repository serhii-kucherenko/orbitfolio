...
export function Variant() {
  ...
  return (
    <main className="min-h-screen" style={{ background: "#ffffff", color: "#111111" }}>
        ...
        <div className="px-6 py-16 md:px-12 md:py-20">
          <div className="grid gap-2 border-b-4 border-black pb-8 sm:grid-cols-12">
            ...
            <div className="sm:col-span-9">
              ...
              <p className="mt-4 text-sm font-medium uppercase tracking-[0.15em] text-[#e11d48]">
                {cv.title}
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 grid gap-8 border-b border-black/15 pb-10 sm:grid-cols-12">
            ...
            <div className="sm:col-span-5">
              <a
                ...
                className="inline-flex bg-black px-5 py-3 text-xs font-bold uppercase tracking-wider text-white"
              >
                Hire now
              </a>
          ...
          <div className="mt-10 grid grid-cols-2 gap-0 border border-black sm:grid-cols-4">
            {cv.highlights.map((h, i) => (
              <motion.div
                ...
                className="border-black p-5 sm:border-r sm:last:border-r-0"
