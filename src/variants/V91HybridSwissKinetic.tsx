...
/** Hybrid Swiss Kinetic — modular grid + Lenis smooth scroll + kinetic red bar. */
    ...
    <SmoothScroll>
      ...
      <footer className="border-t border-black/10 px-6 py-8">
        <p className="mx-auto max-w-5xl text-sm leading-7 text-black/55">
          Swiss kinetic hybrid keeps grid discipline while motion and scroll earn their keep.
        </p>
