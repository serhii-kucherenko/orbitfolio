...
/** Velocity Case Chapters — deepened award cell */
    ...
    <main className="min-h-screen" style={{ background: "#111827", color: "#f9fafb" }}>
      <header className="border-b px-6 py-20 md:px-12" style={{ borderColor: "#fbbf2444" }}>
        <div className="mx-auto max-w-6xl">
          <p className="font-[family-name:var(--font-mono)] text-xs uppercase tracking-[0.35em] opacity-55">Velocity Case Chapters issue</p>
