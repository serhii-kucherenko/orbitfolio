  ...
  return (
    <main className="min-h-screen bg-[#0e1218] text-[#eef3f0]">
      <header className="mx-auto max-w-5xl px-6 pt-28">
        <p className="text-[10px] uppercase tracking-[0.4em] text-teal-300/60">Isometric archive</p>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          ...
          <a
            href="/resume"
            className="inline-block border border-teal-300/40 px-5 py-2.5 text-sm font-semibold text-teal-100"
          >
            Floor plan PDF
          </a>
      ...
      <section className="relative mx-auto mt-12 h-[340px] max-w-5xl px-6 sm:h-[380px]">
        {rooms.map((room, i) => (
          <motion.a
            ...
            className="absolute w-[42%] max-w-[240px] rounded-lg border border-teal-300/25 bg-gradient-to-br from-teal-500/15 to-[#152028] p-4 shadow-xl"
            style={{
              left: room.x,
              top: room.y,
