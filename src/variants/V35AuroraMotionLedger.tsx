...
/** Aurora Motion Ledger — deepened award cell */
    ...
    <main className="min-h-screen" style={{ background: "#0b1220", color: "white" }}>
      <header className="border-b px-6 py-20 md:px-12" style={{ borderColor: "#67e8f944" }}>
        <div className="mx-auto max-w-6xl">
          <p className="font-[family-name:var(--font-mono)] text-xs uppercase tracking-[0.35em] opacity-55">Aurora Motion Ledger issue</p>
