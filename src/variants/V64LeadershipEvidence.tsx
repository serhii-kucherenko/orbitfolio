...
/** Leadership Evidence — deepened award cell */
    ...
    <main className="min-h-screen" style={{ background: "#0f172a", color: "#e2e8f0" }}>
      <header className="border-b px-6 py-20 md:px-12" style={{ borderColor: "#a78bfa44" }}>
        <div className="mx-auto max-w-6xl">
          <p className="font-[family-name:var(--font-mono)] text-xs uppercase tracking-[0.35em] opacity-55">Leadership Evidence issue</p>
